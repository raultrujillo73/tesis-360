...
const diagnostics = defineCollection({
  loader: glob({
    pattern: ['investigacion/estado-del-arte/*.md', 'investigacion/marco-conceptual/*.md', 'investigacion/formulacion/*.md', 'plan_tesis/auditorias/*.md', 'plan_tesis/arquitecturas/*.md'],
    base: './',
